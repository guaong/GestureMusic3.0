...
public class MusicPlayerBinder extends Binder {
    ...
    public MusicPlayerBinder(Context context, MediaPlayer mediaPlayer,
                             ArrayList<Music> musicArrayList, Timer timingTimer, Timer animationTimer){
        ...
        TimingTask mTimingTask = new TimingTask();
        timingHandler = new TimingHandler(mTimingTask, timingTimer);
        ...
        animationTimer.schedule(mTimerTask, 0, 100);
    }
    ...
    public void play(int current){
        try {
            mMediaPlayer.stop();
            mMediaPlayer.reset();
            mMediaPlayer.setDataSource(mContext, mMusicList.get(current).getUri());
